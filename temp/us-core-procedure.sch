...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    ...
    <sch:rule context="f:Procedure">
      ...
      <sch:assert test="not(exists(f:notDoneReason)) or f:notDone/@value=true()">Reason not done is only permitted if notDone indicator is true (inherited)</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
